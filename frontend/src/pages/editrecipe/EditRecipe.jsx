...
//  This is exactly the same as CreateRecipe, except references to "create Recipe"
// or anything of the like were changed to "Edit Recipe". This is not complete.
...
const EditRecipe = () =>
{
    ...
    <div>
        ...
        <div className="newInfo2">
            ...
            <button id="submitButton" onClick={doEditRecipe}>Submit</button>
